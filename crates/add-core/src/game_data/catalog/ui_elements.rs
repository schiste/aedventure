// @generated by `npm run content:build` from packages/add-content/src/content/ui-elements.ts.
// Do not edit by hand; edit the TS source and re-run the generator.

use crate::game_data::*;

pub(in crate::game_data) const UI_ELEMENTS: &[UiElementDef] = &[
    UiElementDef {
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            primary_risk_copy: Some(
                "Before the Crystal is uncovered, its full control surface stays hidden.",
            ),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "World actions temporarily pull the Hero away from band support.",
            ),
            display_priority: 895,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "If Bassline falls too low, the bubble can contract and lose reach.",
            ),
            display_priority: 894,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "No free slots means the Crystal cannot scale without upgrades.",
            ),
            display_priority: 891,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        label: "Output",
        related_ids: &["construction.output", "station.crystal_circle"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
    ...
    UiElementDef {
        ...
        label: "Field Polish",
        related_ids: &["construction.polish_field", "resource.bassline"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[
    ...
    UiElementDef {
        ...
        label: "Bubble Budget",
        related_ids: &["resource.bassline", "ui.map.cave_gate"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "Spending too deeply into Bassline can force the bubble to contract.",
            ),
    ...
    UiElementDef {
        ...
        label: "Source",
        related_ids: &["resource.bassline", "role.crystal_bassline"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Source",
            player_hint: "Shows the primary current source for Bassline.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 887,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Sink",
            player_hint: "Shows the primary current demand on stored Bassline.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 886,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Risk",
            player_hint: "Summarizes the current bubble risk created by Bassline pressure.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 885,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        label: "Rate",
        related_ids: &["resource.chorus", "role.crystal_chorus"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
        ...
        presentation: Some(PresentationDef {
            short_label: "Rate",
            player_hint: "Current Chorus generation per second.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 884,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Stations",
            player_hint: "Powered stations consume Chorus while active.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 883,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Source",
            player_hint: "Shows the primary current source for Chorus.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 882,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Sink",
            player_hint: "Shows the primary current power-side Chorus demand.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 881,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        label: "Risk",
        related_ids: &["resource.chorus", "ui.metric.power.brownout"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
                flag_id: "base.studio_restored",
        ...
        presentation: Some(PresentationDef {
            short_label: "Risk",
            player_hint: "Summarizes current brownout risk driven by Chorus pressure.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Tier",
        related_ids: &["resource.harmonics", "station.resonance_chamber"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
        ...
        presentation: Some(PresentationDef {
            short_label: "Tier",
            player_hint: "Harmonics tier reflects how far efficiency and resilience have progressed.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 879,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Boost",
            player_hint: "Harmonics efficiency boosts the rest of the base economy.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 878,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        label: "Source",
        related_ids: &["resource.harmonics", "role.crystal_harmonics"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
                flag_id: "base.resonance_chamber_built",
        ...
        presentation: Some(PresentationDef {
            short_label: "Source",
            player_hint: "Shows the primary current source for Harmonics.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 877,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Sink",
            player_hint: "Shows where Harmonics-side progress is currently being invested.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 876,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Risk",
            player_hint: "Summarizes the current risk of leaving Harmonics understaffed.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 875,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "Brownouts will shut down the last requested powered station first.",
            ),
    ...
    UiElementDef {
        id: "ui.status.hero",
        label: "Status",
        related_ids: &["world_action.investigate_base", "world_action.explore_base"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
    ...
    UiElementDef {
        ...
        label: "Source",
        related_ids: &["role.construction", "resource.stone", "resource.bassline"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Source",
            player_hint: "Shows the main current input feeding construction progress.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 874,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Sink",
            player_hint: "Shows the active current construction demand.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 873,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Blocker",
            player_hint: "Shows the main thing currently stopping construction from moving.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 872,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Source",
            player_hint: "Shows the main current input to the power layer.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 871,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Sink",
            player_hint: "Shows the main current Chorus demand in the power network.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Blocker",
        related_ids: &["ui.metric.power.brownout", "resource.chorus"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
                flag_id: "base.studio_restored",
        ...
        presentation: Some(PresentationDef {
            short_label: "Blocker",
            player_hint: "Shows the main current blocker in the power and processing layer.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 869,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "High upkeep relative to Chorus income increases brownout pressure.",
            ),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "If Chorus runs thin, life support contributes to brownout pressure.",
            ),
            display_priority: 720,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "Increase Chorus or reduce powered demand to stabilize the base.",
            ),
    ...
    UiElementDef {
        ...
        label: "Stone Stock",
        related_ids: &["resource.stone", "role.scavenge"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
                flag_id: "base.tutorial_explored",
        ...
        presentation: Some(PresentationDef {
            short_label: "Stone Stock",
            player_hint: "Shows how much scavengable stone remains around the base.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 867,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        label: "Water Stock",
        related_ids: &["resource.water", "role.water"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
        ...
        presentation: Some(PresentationDef {
            short_label: "Water Stock",
            player_hint: "Shows how much collectable water remains in the local source.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 866,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Source",
            player_hint: "Shows the main current source feeding the Base layer.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 865,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Sink",
            player_hint: "Shows the main current demand on Base-side materials and Vibes.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 864,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Blocker",
            player_hint: "Shows the main current blocker in the Base layer.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 863,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
    ...
    UiElementDef {
        ...
        label: "Bunks",
        related_ids: &["project.restore_studio"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
                flag_id: "base.studio_restored",
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "Missing bunks will degrade morale and eventually crew performance.",
            ),
    ...
    UiElementDef {
        ...
        label: "Morale Drain",
        related_ids: &["resource.vibes", "project.build_fire_pit"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            cta_copy: None,
            primary_risk_copy: Some(
                "Low crew speed slows construction, gathering, and the whole first-session arc.",
            ),
    ...
    UiElementDef {
        ...
        label: "Scavenge Crew",
        related_ids: &["role.scavenge", "resource.stone"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
                flag_id: "base.tutorial_explored",
    ...
    UiElementDef {
        ...
        label: "Fire Pit Crew",
        related_ids: &["role.fire_pit", "resource.vibes"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
                flag_id: "base.fire_pit_built",
    ...
    UiElementDef {
        ...
        label: "Water Crew",
        related_ids: &["role.water", "resource.water"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::FlagSet {
                flag_id: "base.water_collection_unlocked",
    ...
    UiElementDef {
        ...
        related_ids: &["project.build_fire_pit"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[
                VisibilityConditionDef::FlagSet {
    ...
    UiElementDef {
        id: "ui.map.cave_gate",
        label: "Cave Gate",
        related_ids: &["world_action.explore_base", "resource.bassline"],
        visibility: VisibilityDef {
            all_of: &[],
    ...
    UiElementDef {
        id: "ui.app.view.game",
        label: "Game View",
        related_ids: &["ui.panel.hero", "ui.panel.objectives", "ui.panel.run"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Game View",
            player_hint: "Player-facing view.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Admin View",
        related_ids: &["ui.panel.run"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Admin View",
            player_hint: "Debug and inspection view.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Data Tree",
        related_ids: &["ui.panel.objectives"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Data Tree",
            player_hint: "Catalog and graph inspection view.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        id: "ui.hero.name",
        label: "The Hero",
        related_ids: &["ui.panel.hero"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "The Hero",
            player_hint: "Current run protagonist.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Drummer",
        related_ids: &["role.crystal_bassline"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Drummer",
            player_hint: "Bassline-focused Hero class track.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Vocalist",
        related_ids: &["role.crystal_chorus"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Vocalist",
            player_hint: "Chorus-focused Hero class track.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Synth",
        related_ids: &["role.crystal_harmonics"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Synth",
            player_hint: "Harmonics-focused Hero class track.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Vitals Monitor",
            player_hint: "Shows current Viral Load and strain tier.",
            cta_copy: None,
            primary_risk_copy: Some(
                "If Viral Load crosses the point of no return, forced retreat starts immediately.",
            ),
    ...
    UiElementDef {
        ...
        label: "Wounds",
        related_ids: &["hero.forced_return_active"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Wounds",
            player_hint: "Tracks the Hero wound pool separately from Viral Load.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Return Window",
        related_ids: &["hero.outside_bubble", "hero.forced_return_active"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[
        ...
        presentation: Some(PresentationDef {
            short_label: "Return Window",
            player_hint: "Shows how much safe margin remains before forced retreat or how long retreat will take.",
            cta_copy: None,
            primary_risk_copy: Some(
                "A shrinking window means the Hero is almost out of safe return budget.",
            ),
    ...
    UiElementDef {
        ...
        label: "Recovery",
        related_ids: &["hero.recovering_at_studio", "hero.outside_bubble"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[
        ...
        presentation: Some(PresentationDef {
            ...
            player_hint: "Recovery starts only once the Hero is back in the Studio and slows during severe brownouts.",
            cta_copy: None,
            primary_risk_copy: Some("Brownouts can slow or stop recovery at the Studio."),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Echo Scars",
            player_hint: "Forced returns leave Echo Scars behind even when the Hero survives.",
            cta_copy: None,
            primary_risk_copy: Some(
                "Echo Scars stack and will matter more as the world layer opens up.",
            ),
    ...
    UiElementDef {
        ...
        label: "Strain Tier",
        related_ids: &["hero.outside_bubble"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[
                VisibilityConditionDef::ViralLoadPositive,
        ...
        presentation: Some(PresentationDef {
            short_label: "Strain Tier",
            player_hint: "Viral Load thresholds reduce Hero work and movement before full forced return.",
            cta_copy: None,
            primary_risk_copy: Some(
                "Higher strain makes the Hero slower and less effective outside safety.",
            ),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Forced Return",
            player_hint: "Hero state label during automatic retreat.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Returning to Studio",
            player_hint: "Hero state label after re-entering the bubble during forced return.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        related_ids: &["hero.recovering_at_studio"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Recovering at Studio",
            player_hint: "Hero state label during Studio-bound recovery.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Outside Bubble",
            player_hint: "Hero state label while exposed to the Silence outside safety.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Reach",
        related_ids: &["ui.panel.map", "resource.bassline"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Reach",
            player_hint: "Current bubble reach from the base.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 112,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Frontier",
            player_hint: "Current conversion progress at the bubble edge.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 111,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Target",
            player_hint: "Target bubble reach from current Bassline budget.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 110,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        label: "Cave Gate in",
        related_ids: &["ui.map.cave_gate", "tile.survivor_cave"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::RecruitmentDisabled],
        },
        presentation: Some(PresentationDef {
            short_label: "Cave Gate in",
            player_hint: "Remaining reach needed to open the cave route.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 109,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        related_ids: &["resource.bassline", "ui.panel.map"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Bubble will shrink in",
            player_hint: "Countdown until the bubble contracts if budget stays too low.",
            cta_copy: None,
            primary_risk_copy: Some("Spend less Bassline or grow supply to avoid shrink."),
            display_priority: 108,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Arrival",
            player_hint: "Narrative intro panel for the first five opening beats.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 108,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        label: "Introduction",
        related_ids: &["ui.panel.narrative"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Introduction",
            player_hint: "Narrative intro panel kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 107,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Choose your line",
            player_hint: "Prompt shown before the player commits to a narrative choice.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 106,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Chosen",
            player_hint: "Heading for the selected intro choice.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 105,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "This sets up",
            player_hint: "Label for the playable action unlocked by the current narrative beat.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 104,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Run",
            player_hint: "Run-level save and offline controls.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 103,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "No autosave",
            player_hint: "Shown before the first autosave lands.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 106,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Autosave",
            player_hint: "Latest autosave timestamp.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 104,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "While you were away",
            player_hint: "Offline catch-up summary heading.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 103,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Dismiss",
            player_hint: "Dismiss the offline summary.",
            cta_copy: Some("Dismiss"),
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Reach",
        related_ids: &["ui.panel.run", "resource.bassline"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Reach",
            player_hint: "Offline reach delta.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        label: "Recruits",
        related_ids: &["ui.panel.run", "ui.action.recruit"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Recruits",
            player_hint: "Offline recruit delta.",
            cta_copy: None,
            primary_risk_copy: None,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Save Now",
            player_hint: "Export the current save.",
            cta_copy: Some("Save Now"),
            primary_risk_copy: None,
            display_priority: 99,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Load Autosave",
            player_hint: "Load the browser autosave.",
            cta_copy: Some("Load Autosave"),
            primary_risk_copy: None,
            display_priority: 98,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Load Text",
            player_hint: "Import a pasted save payload.",
            cta_copy: Some("Load Text"),
            primary_risk_copy: None,
            display_priority: 97,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Reset Run",
            player_hint: "Reset the current run to a fresh state.",
            cta_copy: Some("Reset Run"),
            primary_risk_copy: Some("This clears current run progress."),
            display_priority: 96,
            reveal: PresentationReveal::Default,
        }),
    },
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Save Payload",
            player_hint: "Raw serialized save text.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 95,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Data Tree",
            player_hint: "Catalog navigation heading.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 94,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Catalog, schemas, and UI surfaces",
            player_hint: "Data Tree subtitle.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 93,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Filter nodes",
            player_hint: "Search input label for the data tree.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 92,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "No nodes match the current filter.",
            player_hint: "Shown when the Data Tree is filtered to nothing.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 91,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            player_hint: "Selected node definition section.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 90,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Select a node",
            player_hint: "Shown when no Data Tree node is selected.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 89,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Graph",
            player_hint: "Relation graph mode.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 88,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        label: "Timeline",
        related_ids: &["story.beat.investigate_base", "story.beat.stabilize_base"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            ...
            player_hint: "Story-beat timeline mode.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 87,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Graph",
            player_hint: "Graph section title.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 86,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Inspect incoming and outgoing relations around the selected node.",
            player_hint: "Graph help text.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 85,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Reset Graph",
            player_hint: "Clear local graph simulation state.",
            cta_copy: Some("Reset Graph"),
            primary_risk_copy: None,
            display_priority: 84,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Timeline",
            player_hint: "Story-beat timeline section title.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 83,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Browse progression beats by arc and sequence.",
            player_hint: "Timeline help text.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 82,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "No story beats are available for the current filter.",
            player_hint: "Empty state for story timeline.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 81,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            player_hint: "Story beat sequence label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 79,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Visible",
            player_hint: "Visibility state label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 78,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "None",
            player_hint: "Empty relation/value label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 76,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Enabled",
            player_hint: "Graph enabled-state marker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 75,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Simulated Unlock",
            player_hint: "Graph simulated-unlock marker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 74,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Enable Node",
            player_hint: "Enable a node in the local graph simulation.",
            cta_copy: Some("Enable Node"),
            primary_risk_copy: None,
            display_priority: 73,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Disable Node",
            player_hint: "Disable a node in the local graph simulation.",
            cta_copy: Some("Disable Node"),
            primary_risk_copy: None,
            display_priority: 72,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Show hidden nodes",
            player_hint: "Toggle hidden nodes in the graph.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 71,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Incoming",
            player_hint: "Incoming relation column label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 70,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            player_hint: "Selected-node column label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 69,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Enabled Nodes",
            player_hint: "Enabled-nodes list label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 68,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "No nodes enabled",
            player_hint: "Empty state for enabled nodes.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 67,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Potential Unlocks",
            player_hint: "Potential unlocks list label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 66,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "No potential unlocks",
            player_hint: "Empty state for potential unlocks.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 65,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Outgoing",
            player_hint: "Outgoing relation column label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 64,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Kind",
            player_hint: "Definition field label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 63,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Resources",
            player_hint: "Data Tree group label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 60,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "All",
            player_hint: "Relation filter label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 47,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        label: "Construction",
        related_ids: &["ui.panel.construction"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Construction",
            player_hint: "Construction panel kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 39,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Build, repair, and queue the next permanent base milestone here.",
            player_hint: "Construction panel note.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 38,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Power",
            player_hint: "Power panel kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 37,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        related_ids: &["ui.metric.harmonics.tier"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Harmonics Tier",
            player_hint: "Power panel metric label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 36,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Power the stations you need, watch Chorus drain, and avoid brownouts.",
            player_hint: "Power panel note.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 35,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Gather supplies, manage housing pressure, and prepare recruitment.",
            player_hint: "Base panel note.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 33,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Objectives",
            player_hint: "Objectives panel kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 32,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "No direct action",
            player_hint: "Shown when the current objective is passive.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 31,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Simulation",
            player_hint: "Admin simulation section kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 30,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Simulation Controls",
            player_hint: "Admin simulation section title.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 29,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Export Save",
            player_hint: "Admin export action.",
            cta_copy: Some("Export Save"),
            primary_risk_copy: None,
            display_priority: 28,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Tick 10s",
            player_hint: "Advance runtime by 10 seconds.",
            cta_copy: Some("Tick 10s"),
            primary_risk_copy: None,
            display_priority: 27,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Tick 60s",
            player_hint: "Advance runtime by 60 seconds.",
            cta_copy: Some("Tick 60s"),
            primary_risk_copy: None,
            display_priority: 26,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Offline 1h",
            player_hint: "Simulate one hour offline.",
            cta_copy: Some("Offline 1h"),
            primary_risk_copy: None,
            display_priority: 25,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Offline 4h",
            player_hint: "Simulate four hours offline.",
            cta_copy: Some("Offline 4h"),
            primary_risk_copy: None,
            display_priority: 24,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Construction",
            player_hint: "Admin construction section kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 23,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Construction State",
            player_hint: "Admin construction section title.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 22,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Spending",
            player_hint: "Admin spending section kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 21,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Manual Spending",
            player_hint: "Admin spending section title.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 20,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        label: "Spend 10",
        related_ids: &["resource.bassline"],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
        presentation: Some(PresentationDef {
            short_label: "Spend 10",
            player_hint: "Admin spend action.",
            cta_copy: Some("Spend 10"),
            primary_risk_copy: None,
            display_priority: 19,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Spend 25",
            player_hint: "Admin spend action.",
            cta_copy: Some("Spend 25"),
            primary_risk_copy: None,
            display_priority: 18,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Spend 50",
            player_hint: "Admin spend action.",
            cta_copy: Some("Spend 50"),
            primary_risk_copy: None,
            display_priority: 17,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Spend All",
            player_hint: "Admin spend action.",
            cta_copy: Some("Spend All"),
            primary_risk_copy: None,
            display_priority: 16,
            reveal: PresentationReveal::Default,
        }),
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Diagnostics",
            player_hint: "Admin diagnostics section kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 15,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Diagnostics",
            player_hint: "Admin diagnostics section title.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 14,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Persistence",
            player_hint: "Admin persistence section kicker.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 13,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Save Preview",
            player_hint: "Admin persistence section title.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 12,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "No save exported yet.",
            player_hint: "Admin save preview empty state.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 11,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            player_hint: "Data Tree field label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 10,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            ...
            player_hint: "Data Tree section title.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 5,
            reveal: PresentationReveal::Default,
    ...
    UiElementDef {
        ...
        presentation: Some(PresentationDef {
            short_label: "Outgoing",
            player_hint: "Relation column label.",
            cta_copy: None,
            primary_risk_copy: None,
            display_priority: 1,
            reveal: PresentationReveal::Default,
