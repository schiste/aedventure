// @generated by `npm run content:build` from packages/add-content/src/content/entity-schemas.ts.
// Do not edit by hand; edit the TS source and re-run the generator.

use crate::game_data::*;

pub(in crate::game_data) const ENTITY_SCHEMAS: &[EntitySchemaDef] = &[
    EntitySchemaDef {
        ...
        flows: &[
            ...
            FlowDef {
                ...
                related_ids: &["construction.removing_moss"],
            },
            FlowDef {
                item_id: "resource.bassline",
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.studio_restored"],
        }],
        blockers: &[
            BlockerDef {
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.resonance_chamber_built"],
        }],
        blockers: &[
            BlockerDef {
                kind: BlockerKind::MissingRequirement,
            ...
            BlockerDef {
                ...
                related_ids: &["resource.harmonics"],
            },
        ],
        access_rules: &[],
        power: None,
        flows: &[
            ...
            FlowDef {
                ...
                cadence: FlowCadence::PerSecond,
                related_ids: &["station.resonance_chamber", "station.mix_console"],
            },
        ],
        model_refs: &[
            ModelRefDef {
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.water_collection_unlocked"],
        }],
        blockers: &[BlockerDef {
            kind: BlockerKind::BlockedAtCap,
            label: "Water collection pauses at cap.",
            related_ids: &["resource.water"],
        }],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::BaseOnly,
            label: "Water collection is a Base-tile action.",
            related_ids: &["role.water"],
        }],
        power: None,
        flows: &[
            FlowDef {
            ...
            FlowDef {
                ...
                direction: FlowDirection::Output,
                cadence: FlowCadence::Passive,
                related_ids: &["tile.river_shallows", "tile.base_core"],
            },
            FlowDef {
                item_id: "resource.water",
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.fire_pit_built"],
        }],
        blockers: &[],
        access_rules: &[],
        power: None,
        flows: &[
            FlowDef {
                item_id: "resource.vibes",
                label: "Fire Pit produces Vibes passively and from staffed crew.",
                direction: FlowDirection::Output,
                cadence: FlowCadence::PerSecond,
                related_ids: &["role.fire_pit", "station.fire_pit"],
            },
            FlowDef {
                item_id: "resource.vibes",
                ...
                direction: FlowDirection::Input,
                cadence: FlowCadence::OnStart,
                related_ids: &["tile.survivor_cave"],
            },
            FlowDef {
                item_id: "resource.vibes",
    ...
    EntitySchemaDef {
        ...
        blockers: &[BlockerDef {
            ...
            related_ids: &["station.crystal_circle"],
        }],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::BaseOnly,
    ...
    EntitySchemaDef {
        ...
        blockers: &[BlockerDef {
            ...
            related_ids: &["project.restore_studio", "project.build_fire_pit"],
        }],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::BaseOnly,
            label: "Construction is a Base-side role.",
            related_ids: &["structure.base"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "resource.bassline",
    ...
    EntitySchemaDef {
        ...
        flows: &[FlowDef {
            ...
            direction: FlowDirection::Output,
            cadence: FlowCadence::PerSecond,
            related_ids: &["resource.vibes", "role.fire_pit"],
        }],
        model_refs: &[],
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.mix_console_built"],
        }],
        blockers: &[
            BlockerDef {
                kind: BlockerKind::MissingRequirement,
        ...
        flows: &[
            ...
            FlowDef {
                ...
                direction: FlowDirection::Output,
                cadence: FlowCadence::OnComplete,
                related_ids: &["recipe.mix_signal_balancing"],
            },
        ],
        model_refs: &[ModelRefDef {
            kind: ModelKind::Power,
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.workshop_built"],
        }],
        blockers: &[
            BlockerDef {
                kind: BlockerKind::MissingRequirement,
        ...
        flows: &[
            FlowDef {
                ...
                direction: FlowDirection::Input,
                cadence: FlowCadence::OnStart,
                related_ids: &["recipe.workshop_builder_tools"],
            },
            FlowDef {
                item_id: "resource.water",
                ...
                direction: FlowDirection::Output,
                cadence: FlowCadence::OnComplete,
                related_ids: &["recipe.workshop_water_condensers"],
            },
        ],
        model_refs: &[
            ModelRefDef {
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.research_booth_built"],
        }],
        blockers: &[
            BlockerDef {
                kind: BlockerKind::MissingRequirement,
        ...
        flows: &[
            FlowDef {
                ...
                direction: FlowDirection::Output,
                cadence: FlowCadence::OnComplete,
                related_ids: &["recipe.research_chorus_routing"],
            },
            FlowDef {
                item_id: "resource.harmonics",
                ...
                direction: FlowDirection::Output,
                cadence: FlowCadence::OnComplete,
                related_ids: &["recipe.research_harmonic_study"],
            },
        ],
        model_refs: &[
            ModelRefDef {
    ...
    EntitySchemaDef {
        ...
        flows: &[
            ...
            FlowDef {
                item_id: "station.crystal_circle",
    ...
    EntitySchemaDef {
        ...
        flows: &[
            ...
            FlowDef {
                ...
                direction: FlowDirection::Output,
                cadence: FlowCadence::OnComplete,
                related_ids: &["resource.bassline", "resource.chorus", "resource.harmonics"],
            },
        ],
        model_refs: &[ModelRefDef {
            kind: ModelKind::Duration,
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["crystal.removing_moss_unlocked"],
        }],
        blockers: &[BlockerDef {
            kind: BlockerKind::MissingRequirement,
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.tutorial_explored"],
        }],
        blockers: &[BlockerDef {
            kind: BlockerKind::MissingResource,
            label: "Requires Skin and Water upfront.",
            related_ids: &["cost.skin", "resource.water"],
        }],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::BaseOnly,
            label: "Crystal upgrades happen at the Base.",
    ...
    EntitySchemaDef {
        ...
        blockers: &[
            BlockerDef {
                ...
                related_ids: &["base.studio_restore_unlocked"],
            },
            BlockerDef {
                kind: BlockerKind::MissingResource,
    ...
    EntitySchemaDef {
        ...
        flows: &[FlowDef {
            ...
            direction: FlowDirection::Unlock,
            cadence: FlowCadence::OnComplete,
            related_ids: &["role.crystal_harmonics", "station.resonance_chamber"],
        }],
        model_refs: &[],
        notes: &[],
    },
    EntitySchemaDef {
        ...
        blockers: &[
            BlockerDef {
                ...
                related_ids: &["base.studio_restored", "base.resonance_chamber_built"],
            },
            BlockerDef {
                kind: BlockerKind::MissingResource,
                label: "Requires Stone upfront.",
    ...
    EntitySchemaDef {
        ...
        power: None,
        flows: &[FlowDef {
            item_id: "station.research_booth",
    ...
    EntitySchemaDef {
        ...
        blockers: &[
            ...
            BlockerDef {
                ...
                related_ids: &["resource.stone", "resource.water"],
            },
        ],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::BaseOnly,
        ...
        power: None,
        flows: &[FlowDef {
            item_id: "base.bunks_capacity",
            label: "Adds five bunks when complete.",
            direction: FlowDirection::Capacity,
            cadence: FlowCadence::OnComplete,
            related_ids: &["ui.action.recruit"],
        }],
        model_refs: &[],
        notes: &[],
    },
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.workshop_built", "base.water_collection_unlocked"],
        }],
        blockers: &[
            BlockerDef {
                kind: BlockerKind::MissingRequirement,
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.resonance_chamber_built", "base.workshop_built"],
        }],
        blockers: &[
            BlockerDef {
                kind: BlockerKind::MissingRequirement,
        ...
        power: None,
        flows: &[FlowDef {
            item_id: "construction.polish_field",
    ...
    EntitySchemaDef {
        ...
        power: None,
        flows: &[FlowDef {
            item_id: "recipe.research_chorus_routing",
            label: "Improves Chorus routing when complete.",
            direction: FlowDirection::Unlock,
            cadence: FlowCadence::OnComplete,
            related_ids: &["station.research_booth"],
        }],
        model_refs: &[],
        notes: &[],
    },
    EntitySchemaDef {
        ...
        blockers: &[
            ...
            BlockerDef {
                ...
                related_ids: &["station.resonance_chamber"],
            },
            BlockerDef {
                kind: BlockerKind::MissingResource,
    ...
    EntitySchemaDef {
        ...
        blockers: &[
            ...
            BlockerDef {
                ...
                related_ids: &["station.mix_console"],
            },
            BlockerDef {
                kind: BlockerKind::MissingResource,
                label: "Consumes Stone and Water upfront.",
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["base.tutorial_investigated"],
        }],
        blockers: &[BlockerDef {
            kind: BlockerKind::OfflineDisabled,
            label: "Investigate only progresses while online.",
            related_ids: &["world_action.investigate_base"],
        }],
        access_rules: &[
            AccessRuleDef {
                kind: AccessRuleKind::BaseOnly,
        ...
        power: None,
        flows: &[FlowDef {
            item_id: "world_action.explore_base",
    ...
    EntitySchemaDef {
        ...
        power: None,
        flows: &[FlowDef {
            item_id: "base.studio_restore_unlocked",
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["story.beat.first_glimpse", "tile.base_core"],
        }],
        blockers: &[],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::StoryUnlocked,
            label: "This beat establishes the arrival path into the playable space.",
            related_ids: &["story.beat.first_glimpse", "structure.base"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "story.beat.first_glimpse",
            label: "Leads into the Base reveal sequence.",
            direction: FlowDirection::Unlock,
            cadence: FlowCadence::OnComplete,
            related_ids: &["story.beat.first_glimpse"],
        }],
        model_refs: &[],
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["story.beat.enter_the_bubble", "structure.crystal_circle"],
        }],
        blockers: &[],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::StoryUnlocked,
            label: "The Base and Crystal Circle must already exist in the scene framing.",
            related_ids: &["tile.ridge_line", "tile.base_core"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "story.beat.enter_the_bubble",
    ...
    EntitySchemaDef {
        ...
        access_rules: &[AccessRuleDef {
            ...
            related_ids: &["resource.bassline", "station.crystal_circle"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "world_action.investigate_base",
    ...
    EntitySchemaDef {
        ...
        unlocks: &[UnlockDef {
            ...
            related_ids: &["world_action.explore_base", "story.beat.explore_base"],
        }],
        blockers: &[BlockerDef {
            kind: BlockerKind::Busy,
        ...
        access_rules: &[AccessRuleDef {
            ...
            related_ids: &["structure.base", "tile.base_core"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "world_action.investigate_base",
    ...
    EntitySchemaDef {
        ...
        power: None,
        flows: &[FlowDef {
            item_id: "project.restore_studio",
    ...
    EntitySchemaDef {
        ...
        access_rules: &[AccessRuleDef {
            ...
            related_ids: &["structure.base", "station.fire_pit"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "project.build_fire_pit",
    ...
    EntitySchemaDef {
        ...
        access_rules: &[AccessRuleDef {
            ...
            related_ids: &["resource.bassline", "tile.survivor_cave"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "ui.map.cave_gate",
    ...
    EntitySchemaDef {
        ...
        blockers: &[BlockerDef {
            ...
            related_ids: &["ui.status.base.recruits"],
        }],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::ReachRequired,
            label: "This beat exists only once recruitment has actually started.",
            related_ids: &["ui.action.recruit", "ui.status.base.recruits"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "ui.status.base.recruits",
    ...
    EntitySchemaDef {
        ...
        blockers: &[BlockerDef {
            ...
            related_ids: &["ui.panel.power", "ui.status.base.housing"],
        }],
        access_rules: &[AccessRuleDef {
            kind: AccessRuleKind::BaseOnly,
            label: "This beat is about optimizing the Base after the first recruit arrives.",
            related_ids: &["structure.base", "ui.panel.base"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "ui.panel.power",
    ...
    EntitySchemaDef {
        ...
        access_rules: &[AccessRuleDef {
            ...
            related_ids: &["structure.base", "structure.crystal_circle"],
        }],
        power: None,
        flows: &[
            FlowDef {
    ...
    EntitySchemaDef {
        ...
        access_rules: &[AccessRuleDef {
            ...
            related_ids: &["tile.river_shallows"],
        }],
        power: None,
        flows: &[FlowDef {
            item_id: "resource.water",
            ...
            direction: FlowDirection::Output,
            cadence: FlowCadence::Passive,
            related_ids: &["resource.water", "flora.reeds"],
        }],
        model_refs: &[ModelRefDef {
            kind: ModelKind::Terrain,
            reference_id: "terrain_impedance",
    ...
    EntitySchemaDef {
        ...
        blockers: &[
            BlockerDef {
                ...
                related_ids: &["tile.mountain_wall"],
            },
            BlockerDef {
